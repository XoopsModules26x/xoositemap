...
define('_HELP_INSTALL_CONTENT', 'Extra, or non-core, modules are usually downloadable as compressed files (zip, tar). Always check if a text file with upload instructions is included in the downloaded package.
    <ol>
